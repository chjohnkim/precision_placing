...
#    gposition(pub, command, 220)
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597) ## WIDE VIEW POSITION
#    track_apriltag(3, '/tag_3', -0.004, 0.017, 0.360)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.003, 0.01)
...
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  #WIDE VIEW POSITION
#    track_apriltag(7, '/tag_7', -0.038, 0.016, 0.32)
#    rospy.sleep(1)
#    pivot = TurnArc_Battery2(offset, 'y', 90 - theta_0, 1, 'y', 1)
#    rospy.sleep(0.5)
#    linear_path_battery('z', -0.015, 0.01)
#    rospy.sleep(0.5)
#    linear_path_battery('x', -0.0025, 0.01)
#    rospy.sleep(0.5)
#    [width, opposite] = regrasp8(theta_0, delta_0, 50, object_width, 'y', 1, 'y', 1, command)
#    rospy.sleep(1)
#    TurnArcAboutAxis_3('y', pivot[0]-0.015, pivot[1]-0.0025, 19, 1, 'yes', 'y', 1)
#    rospy.sleep(0.5)
