...
##___FRAME INSERTION ROUTINE (PICTURE FRAME)___###
#################################################################################################
###___PARAMETERS___###
...
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  #WIDE VIEW POSITION
#    rospy.sleep(1)
#    track_apriltag(6, '/tag_6', -0.045, 0.019, 0.37)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.003, 0.01)
#    pickup(command, -delta_0+0.007, 0.05)
#######___GO TO PHONE BATTERY RECEPTACLE AND INSERTION ROUTINE___###
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597) # WIDE VIEW POSITION    
#    track_apriltag(6, '/tag_6', -0.06, 0.101, 0.365)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.0015, 0.01)
#    rospy.sleep(1)
#    force_seek2('x', -0.1, 'x', 6, 0.001, 0.01)
#    pivot = TurnArc_Battery(offset, 'y', 90-theta_0, 1, 'y', 1)
#    rospy.sleep(1)
#    [width, opposite] = regrasp7(theta_0, delta_0, 65, object_width, 'y', 1, 'y', 1, command)
#    rospy.sleep(1)
...
#######___LEGO INSERTION ROUTINE___###
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597) # WIDE VIEW POSITION
#    track_apriltag(6, '/tag_6', 0.1015, 0.014, 0.36)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.001, 0.01)
#    pivot = TurnArc_Battery(offset, 'y', 90-theta_0, 1, 'y', 1)
#    rospy.sleep(1)
...
#    gposition(pub, command, 220)
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597) # WIDE VIEW POSITION
#    track_apriltag(2, '/tag_2', -0.016, 0.024, 0.345)
#    rospy.sleep(1)
...
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  #WIDE VIEW POSITION
#    track_apriltag(7, '/tag_7', -0.038, 0.003, 0.335)
#    rospy.sleep(1)
...
#    rospy.sleep(0.5)
#    linear_path_battery('z', -0.036, 0.01)
#    rospy.sleep(0.5)
#    linear_path_battery('x', -0.009, 0.01)
#    rospy.sleep(0.5)
#    [width, opposite] = regrasp8(theta_0, delta_0, 43, object_width, 'y', 1, 'y', 1, command)
#    rospy.sleep(1)
#    TurnArcAboutAxis_3('y', pivot[0]-0.0255, pivot[1]-0.011, 15, 1, 'yes', 'y', -1)
#    rospy.sleep(0.5)
#    linear_path_battery('x', -0.008, 0.01)
#    rospy.sleep(0.5)
#    rotate_tuck(23, 0)
#    rospy.sleep(0.5)
#    linear_path_battery('x', 0.027, 0.01)
#    rospy.sleep(0.5)
...
#    rospy.sleep(1)
#    track_apriltag(6, '/tag_6', -0.004, -0.014, 0.38)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.003, 0.01)
#    pickup(command, -delta_0+0.002, 0.05)
#######___GO TO CARD RECEPTACLE AND INSERTION ROUTINE___###
#    assign_joint_value(-0.20199710527528936, -1.158487621937887, -1.7146404425250452, -3.397393528615133, -1.7620771566974085, 1.5720199346542358) ##VERTICAL POSITION
#    rospy.sleep(0.5)
#    linear_path_battery('x', -0.098, 0.01) 
#    rospy.sleep(1)
#    linear_path_battery('z', 0.009, 0.01) 
...
###___CARD INSERTION ROUTINE SPEED TEST___###
##################################################################################################
###___PICK UP CARD ROUTINE___###
#    global velocity 
#    object_length = 0.0853 #object total length in meters
...
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  ###WIDE VIEW POSITION
#    rospy.sleep(1)
#    assign_joint_value(0.20406, -2.19398, -1.20209, -4.45601, -1.56792, 1.77302)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.003, 0.01)
#    pickup(command, -delta_0+0.006, 0.05)
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  ##WIDE VIEW POSITION  
#    rospy.sleep(1)
#    assign_joint_value(0.0284, -2.1084, -1.3091, -4.4364, -1.5691, 1.5974)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.002, 0.01)
#    rospy.sleep(1)
#    force_seek2('x', -0.1, 'x', 4, 0.001, 0.01)
...
#    [width, opposite] = regrasp7(theta_0, delta_0, 70, object_width, 'y', 1, 'y', 1, command)
#    rospy.sleep(0.1)
#    TurnArcAboutAxis_2('y', pivot[0], pivot[1], 25, 1, 'yes', 'y', 1)
#    rospy.sleep(0.1)
#    rotate_tuck(17, -0.001)
#    rospy.sleep(0.1)    
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)
...
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  ###WIDE VIEW POSITION
#    rospy.sleep(0.5)
#    assign_joint_value(0.3156225383281708, -2.006571118031637, -1.527811352406637, -4.3151721397983, -1.570822540913717, 1.8855721950531006)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.003, 0.01)
#    pickup(command, -delta_0+0.006, 0.05)
#    assign_joint_value(0.025, -2.114, -1.034, -4.706, -1.569, 1.597)  ##WIDE VIEW POSITION  
#    rospy.sleep(1)
#    assign_joint_value(0.08673732727766037, -2.1505258719073694, -1.2458041349994105, -4.456910792981283, -1.5686891714679163, 1.6550005674362183)
#    rospy.sleep(1)
#    force_seek2('z', -0.1, 'z', 5, 0.002, 0.01)
#    rospy.sleep(1)
#    force_seek2('x', -0.1, 'x', 4, 0.001, 0.01)
